...
const sections = [
  ...
  { title: "Cancellations", body: "Each booking includes one free cancellation. Cancellations made more than 24 hours before the tour start time are eligible for a full refund. Cancellations within 24 hours are non-refundable. After using your free cancellation, any further cancellation requests must be handled through our support team and refunds are not guaranteed." },
  { title: "Rescheduling", body: "Each booking includes one free reschedule, subject to availability. After using your free reschedule, any further changes must be requested through our support team. You can manage your booking using the link provided in your confirmation email." },
