...
const STORAGE = 'https://jqvikplowgcaeawnjyov.supabase.co/storage/v1/object/public/tours';

const IMG = {
  historicCenter: `${STORAGE}/historic-center.jpg`,
  romaCondesa:    `${STORAGE}/roma-condesa.jpg`,
  reforma:        `${STORAGE}/reforma-juarez.jpg`,
  coyoacan:       `${STORAGE}/coyoacan.jpg`,
  chapultepec:    `${STORAGE}/chapultepec.jpg`,
  teotihuacan:    `${STORAGE}/teotihuacan.jpg`,
  polanco:        `${STORAGE}/polanco.jpg`,
  custom:         `${STORAGE}/custom.jpg`,
};
...
const tours = [
  {
    ...
    full_description: 'Immerse yourself in the vibrant soul of Mexico City on this 3-hour walking tour through the Historic Center. Begin at the iconic Zocalo, explore the ruins of Templo Mayor, marvel at Diego Rivera murals inside the National Palace, and discover hidden courtyards and street art along the way.',
    cover_image: IMG.historicCenter,
    gallery_images: [IMG.historicCenter, IMG.romaCondesa],
    area: 'Centro Historico',
    duration: '3 Hours',
    meeting_point: 'Zocalo Plaza, Metro Zocalo Exit',
    language: 'EN / ES',
    type: 'shared',
    base_price: 20,
  ...
  },
  {
    ...
    full_description: 'Discover two of Mexico City\'s most beloved neighborhoods on this 3.5-hour walking tour. Stroll through tree-lined streets, admire Art Deco architecture, visit Parque Mexico, and explore the independent galleries, bookshops, and coffee culture that define this creative district.',
    cover_image: IMG.romaCondesa,
    gallery_images: [IMG.romaCondesa, IMG.reforma],
    area: 'Roma / Condesa',
    duration: '3 Hours',
    meeting_point: 'Parque Mexico, Condesa',
    language: 'EN / ES',
    type: 'shared',
    base_price: 20,
    price_label: '$20 / person',
    ...
    weekday: 3, // Wednesday
    departure_time: '10:00',
    highlights: ['Art Deco architecture', 'Parque Mexico', 'Independent galleries and bookshops', 'Local café culture'],
    included_items: ['Professional bilingual guide', 'Bottled water'],
    faq_items: [{ question: 'Is this tour walkable?', answer: 'Yes, approximately 3 km at a relaxed pace with stops.' }],
  },
  {
    title: 'Reforma + Juarez Tour',
    slug: 'reforma-juarez',
    short_description: 'Walk the grand boulevard of Reforma and discover the hidden gems of Colonia Juarez.',
    full_description: 'This 3.5-hour tour takes you along Paseo de la Reforma — Mexico City\'s most iconic boulevard — and into the elegant streets of Colonia Juarez. Discover monuments, embassies, and the neighborhood\'s rich history as a hub of culture and nightlife.',
    cover_image: IMG.reforma,
    gallery_images: [IMG.reforma, IMG.historicCenter],
    area: 'Reforma / Colonia Juarez',
    duration: '3 Hours',
    meeting_point: 'Angel de la Independencia, Paseo de la Reforma',
    language: 'EN / ES',
    type: 'shared',
    base_price: 20,
    price_label: '$20 / person',
    ...
    weekday: 4, // Thursday
    departure_time: '10:00',
    highlights: ['Paseo de la Reforma boulevard', 'Angel de la Independencia monument', 'Colonia Juarez architecture', 'Cultural landmarks'],
    included_items: ['Professional bilingual guide', 'Bottled water'],
  ...
  },
  {
    ...
    full_description: 'Step into the bohemian charm of Coyoacan on this 4-hour tour. Visit the iconic Casa Azul (Frida Kahlo Museum), explore the lively Jardín Centenario and Mercado de Coyoacan, and discover hidden gems. The tour includes tastings of local street food and traditional sweets.',
    cover_image: IMG.coyoacan,
    gallery_images: [IMG.coyoacan, IMG.romaCondesa],
    area: 'Coyoacan',
    duration: '3 Hours',
    meeting_point: 'Jardín Centenario, Coyoacan',
    language: 'EN / ES',
    type: 'shared',
    base_price: 20,
    price_label: '$20 / person',
    ...
    weekday: 5, // Friday
    departure_time: '10:00',
    highlights: ['Casa Azul — Frida Kahlo Museum', 'Jardín Centenario', 'Mercado de Coyoacan', 'Local street food tastings'],
  ...
  {
    title: 'Teotihuacan Tour',
    slug: 'teotihuacan',
    short_description: 'Rise early and climb the Pyramids of the Sun and Moon before the crowds arrive.',
    full_description: 'An early morning journey to the ancient city of Teotihuacan, one of the most significant archaeological sites in the Americas. Climb the Pyramid of the Sun and the Pyramid of the Moon, walk the Avenue of the Dead, and explore the Temple of Quetzalcoatl. We depart early to experience the site at its most magical — quiet, golden, and alive.',
    ...
    highlights: ['Pyramid of the Sun', 'Pyramid of the Moon', 'Avenue of the Dead', 'Temple of Quetzalcoatl', 'Early morning golden light'],
  ...
  },
  {
    ...
    full_description: 'Polanco is Mexico City\'s most sophisticated neighborhood — home to world-class restaurants, luxury boutiques, and important cultural institutions. This private tour is tailored to your interests: architecture, contemporary art, gastronomy, or all three.',
    cover_image: IMG.polanco,
    gallery_images: [IMG.polanco, IMG.reforma],
    area: 'Polanco',
    duration: '3 Hours',
    meeting_point: 'Parque Lincoln, Polanco',
    language: 'EN / ES',
    type: 'shared',
    base_price: 20,
    price_label: '$20 / person',
